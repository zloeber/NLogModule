...
function Get-NLogInstance {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/Get-NLogInstance.md
    #>
    param ()
...
function Get-NLogMessageLayout {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/Get-NLogMessageLayout.md
    #>
    [CmdletBinding()]
    param (
        [parameter()] 
...
function New-NLogConfig {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/New-NLogConfig.md
    #>
...
function New-NLogConsoleTarget {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/New-NLogConsoleTarget.md
    #>
    [CmdletBinding()]
    param (
        [Parameter()]
...
function New-NLogFileTarget {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/New-NLogFileTarget.md
    #>
    [CmdletBinding()]
    param (
        [Parameter()]
...
function New-NLogLogger {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/New-NLogLogger.md
    #>
    param (
        [parameter(mandatory=$true)] 
...
function New-NLogTarget {
    ...
    .EXTERNALHELP NLogModule-help.xml
    .LINK
        https://github.com/zloeber/nlogmodule/tree/master/release/0.0.1/docs/Functions/New-NLogTarget.md
    #>
    param (
        [parameter(mandatory=$true)]
